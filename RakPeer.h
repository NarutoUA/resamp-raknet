...
struct PlayerIDAndIndex
{
    PlayerID playerId; unsigned index;
};
...
protected:
    ...
    friend void SendClientMessage(RakPeer* rakPeer, PlayerID playerId, DWORD dwColor, const char* szText);
#else
    ...
    struct RequestedConnectionStruct
    {
        ...
        enum
        {
            CONNECT = 1, /*PING=2, PING_OPEN_CONNECTIONS=4,*/ /*ADVERTISE_SYSTEM=2*/
        } actionToTake;
    };
    ...
    struct BufferedCommandStruct
    {
        ...
        enum
        {
            BCS_SEND, BCS_CLOSE_CONNECTION, /*BCS_RPC, BCS_RPC_SHIFT,*/ BCS_DO_NOTHING
        } command;
    };
