...
PlayerID RakServer::GetAnyPlayerIDFromIndex(int index)
{
    return RakPeer::GetAnyPlayerIDFromIndex(index);
}

void RakServer::AddToBanList(const char *IP, RakNetTime milliseconds/*=0*/)
{
...
RemoteSystemStruct* RakServer::GetRemoteSystemFromPlayerID(const PlayerID playerId)
{
    return RakPeer::GetRemoteSystemFromPlayerID(playerId, false, false);
}

RemoteSystemStruct* RakServer::GetRemoteSystemFromPlayer(PlayerID pid)
{
    return RakPeer::GetRemoteSystemFromPlayerID(pid, false, false);
}
